...
async def worker_loop():
    ...
    while True:
        ...
        # Allow CPU side to specify a per-episode result queue.
        target_result_queue = ((job.get("meta") or {}).get("result_queue")) or RESULT_QUEUE
        # Include episode_id in result for easier debugging/filtering.
        result["meta"] = result.get("meta") or {}
        result["meta"]["episode_id"] = (job.get("meta") or {}).get("episode_id")
